...
const CaregiverDashboard = () => {
  ...
  // Mock data - TODO: Replace with real data from patient
  const status: "ok" | "warning" | "alert" = "ok";
  const mood: "happy" | "neutral" | "sad" | "concerned" = "happy";
  const interactionCount = 5;
  const analysisText = "Sarah had a good morning chat. Took medication on time. Planning a short walk after lunch.";
